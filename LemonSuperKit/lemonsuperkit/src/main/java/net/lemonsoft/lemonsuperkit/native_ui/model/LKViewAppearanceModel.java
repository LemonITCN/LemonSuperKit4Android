package net.lemonsoft.lemonsuperkit.native_ui.model;
...
public class LKViewAppearanceModel {
     ...
     * @param context 上下文对象
     */
    public LKViewAppearanceModel(Context context) {
